...
class database:
    ...
    def getBalance(self, id):
        return self.__callProcedure("GetBalance", (id, 0, 0))  # The procedure returns on zeros. Balance, Processed?

    def getStudentName(self, id):
        return self.__callProcedure("GetStudentName", (id, 0, 0))  # Name, Processed?

    def changeBalance(self, id, difference):
        return self.__callProcedure("ChangeBalance", (id, difference, 0))  # Processed?

    def addAccount(self, id, name, balance):
        return self.__callProcedure("AddAccount", (id, name, balance, 0))  # Processed?
