...
try:
    var = subprocess.check_output('./chip_reader.c').decode('utf-8').strip(); # declare variable var, read the output of quick_start_example1 script and decode it from the UTF-8 format and strip it of any extra trailing characters like line breaks
